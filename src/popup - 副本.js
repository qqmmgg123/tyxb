            ...
            <div ref={(popbd) => { this._popbd = popbd }} className="dream-area">
                <form id="deamcreat-form" action="/dream/new" method="post">
                    ...
                    <div style={{ display: 'none' }}>
                        <p className="field"><textarea id="textContent" placeholder="文章" name="text"></textarea></p>
                    </div>
        ...
        return (
            <div ref={(popbd) => { this._popbd = popbd }} className="dream-area">
                <form id="deamcreat-form" action="/dream/new" method="post">
                    ...
                    <div className="form-group">
                        <p className="field"><input data-cname="网址" id="dream-title" name="content" placeholder="网址" /></p>
                    </div>
                    <div className="title-head">
                        <span className="require">*&nbsp;</span>标题
                    </div>
                    ...
                    <div className="title-head">
                        <span className="require">*&nbsp;</span>封面图
                    </div>
                    <div className="form-group">
                        <p className="field">
        ...
        return (
            <div>
                <div className="tab-nav">
                    <ul>
                        <li><a href="javascript:;" className="tab cur">写文章</a></li>
                        <li><a href="javascript:;" className="tab">分享链接</a></li>
                    </ul>
                </div>
