...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (factory) {
	    module.exports = factory(__webpack_require__(12), __webpack_require__(14).default, __webpack_require__(45).default, __webpack_require__(25), __webpack_require__(63), __webpack_require__(46), __webpack_require__(116));
	})(function (utils, req, effect, common, dropdown, popup, router) {
	    var _d = document,
	        _w = window;

	    var postImageBtn = _d.querySelector('#postImage');
	    postImageBtn && postImageBtn.addEventListener('click', function () {
	        common.textNew('image');
	    });

	    // 发布文字
	    var postTextEdit = _d.querySelector('#PostText');
	    postTextEdit && postTextEdit.addEventListener('focus', function () {
	        common.textNew('text');
	    });

	    var postLinkBtn = _d.querySelector('#postLink');
	    postLinkBtn && postLinkBtn.addEventListener('click', function () {
	        common.textNew('news');
	    });
	    ...
	    dreamList && dreamList.addEventListener('click', function (ev) {
	        ...
	        while (cur.getAttribute && ['dream-good', 'dream-bad', 'dream-favourite', 'dream-delete', 'dream-picsrc', 'text-view', 'key-category', 'key-mood', 'key-health'].indexOf(cur.getAttribute('rel')) === -1 && cur.parentNode && cur.parentNode !== ev.currentTarget) {
	            cur = cur.parentNode;
	        }
	        ...
	        if (cur.getAttribute && cur.getAttribute('rel')) {
	            ...
	            // 收藏/取消收藏
	                ...
	                // 删除想法
	                        ...
	                        ev.preventdefault;
	                        var _did = utils.getData(cur, "did");
	                        _w.curDreamItem = utils.closest(cur, '.list-item');
	                        common.showTextViewer(_did, cur);
	                    }
	        }
	    });
