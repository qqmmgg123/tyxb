...
module.exports = function(schema, options) {
    ...
    schema.statics.serializeUser = function() {
        return function(user, cb) {
            cb(null, user.get(usernameField));
        };
    };
    ...
    schema.statics.consumeRememberMeToken = function(token, fn) {
    ...
    schema.statics.saveRememberMeToken = function(token, uid, fn) {
        tokens[token] = uid;
        return fn();
    };

    schema.statics.issueToken = function(user, done) {
